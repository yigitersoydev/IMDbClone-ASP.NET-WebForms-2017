<%@ Control Language="C#" AutoEventWireup="true" CodeFile="YearMovies.ascx.cs" Inherits="Theme_UCs_YearMovies" %>
<asp:Repeater ID="rptr_Year_Movies" runat="server">
    <HeaderTemplate>
        ...
        <div class="clearfix">
            ...
            <div class="main-side clearfix" style="width: 100%;">
               ...
               <h5 style="font: 700 20px/20px 'oswald', trebuchet ms;color: #222222;display: block;text-transform: uppercase;">2017 YILININ EN ÇOK OYLANAN FİLMLERİ</h5>
                </div>
    </HeaderTemplate>
