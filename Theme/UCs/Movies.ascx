<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Movies.ascx.cs" Inherits="Theme_UCs_Movies" %>
<asp:Repeater ID="rptr_Movies" runat="server">
    <HeaderTemplate>
   <!--  <div class="clearfix"> 
    ...
    <div class="main-side clearfix" style="width:100%;">
       <div class="heading h-three h-two title">
        ...
        <h5 style="font: 700 20px/20px 'oswald', trebuchet ms;color: #222222;display: block;text-transform: uppercase;">FİLMLER (A-Z)</h5>
      </div> 
       -->
