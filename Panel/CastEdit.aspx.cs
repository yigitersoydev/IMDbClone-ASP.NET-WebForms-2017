...
public partial class Panel_CastEdit : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            try
            {
                ...
                SqlCommand komut = new SqlCommand("select * from Actors where ID=" + edit, baglanti);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            int sonucx = DB.sorgu("update Actors SET FirstName='" + txtAd.Text + "', LastName='" + txtSoyad.Text + "', Nation= '" + txtNation.Text + "' where ID=" + Request.QueryString["edit"].ToString() + "");
            if (sonucx == 1)
            {
