...
public partial class Panel_DirectorAdd : System.Web.UI.Page
{
    string yol;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string yukleme = Request.PhysicalApplicationPath + "Images/DirectorImage/";
        ...
        SqlCommand sorgu = new SqlCommand("insert into Directors(FirstName,LastName,Birth,Nation,Image) values (@ad,@soyad,@tarih,@ulus,@resim)", baglanti);
