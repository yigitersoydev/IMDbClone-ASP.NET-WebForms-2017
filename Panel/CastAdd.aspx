<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/PanelMaster.master" AutoEventWireup="true" CodeFile="CastAdd.aspx.cs" Inherits="Panel_CastAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphPanelContent" Runat="Server">
     <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Oyuncu Ekle</h3>
    ...
    <asp:Panel ID="success" runat="server" Visible="false">
        <div class="alert alert-success" role="alert">Oyuncu Başarılı Bir Şekilde Eklendi.</div>
    </asp:Panel>
 ...
 <div class="form-group">
        <label>Oyuncunun Doğum Tarihi</label><br />
...
<div class="form-group">
        <label>Oyuncunun Fotoğrafı</label>
        <asp:FileUpload ID="FileUpload1" CssClass="form-control" runat="server" />
    </div>
    <div class="form-group">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Oyuncu Ekle" OnClick="Button1_Click" />
    </div>
                               </div>
                        <!-- /.box-body -->
