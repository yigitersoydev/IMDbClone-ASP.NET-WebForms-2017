<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/PanelMaster.master" AutoEventWireup="true" CodeFile="Movies.aspx.cs" Inherits="Panel_Movies" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphPanelContent" Runat="Server">
      <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Filmler</h3>
    ...
    <asp:Repeater ID="newsgrid" runat="server">
        ...
        <ItemTemplate>
            ...
            <tr>
                ...
                <td>
             <%# Convert.ToDateTime(Eval("ReleaseDate")).ToString("dd/MM/yyyy")%>
                </td>
                <td>
             <%#Eval("Rate") %>
                </td>
