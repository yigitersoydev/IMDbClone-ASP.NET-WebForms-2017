<%@ Page Title="" Language="C#" MasterPageFile="~/Panel/PanelMaster.master" AutoEventWireup="true" CodeFile="DirectorEdit.aspx.cs" Inherits="Panel_DirectorEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphPanelContent" Runat="Server">
    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Yönetmen Düzenle</h3>
   ...
   <div class="form-group">
    ...
    <div class="form-group">
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" Text="Yönetmen Bilgilerini Güncelle" OnClick="Button1_Click"  />
    </div>
       </div>
                        <!-- /.box-body -->
